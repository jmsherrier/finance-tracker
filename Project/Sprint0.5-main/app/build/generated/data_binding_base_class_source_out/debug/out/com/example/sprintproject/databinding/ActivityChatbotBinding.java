...
public final class ActivityChatbotBinding implements ViewBinding {
  ...
  private ActivityChatbotBinding(@NonNull ConstraintLayout rootView, @NonNull TextView chatbot) {
  ...
  public static ActivityChatbotBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityChatbotBinding((ConstraintLayout) rootView, chatbot);
    }
