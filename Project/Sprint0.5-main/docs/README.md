...
Placeholder: Add the use case diagram image in `docs/use_case_diagram.png`.
...
- Use Case Diagram: `docs/use_case_diagram.png` (placeholder)
...
Please add the required images into the `docs/` folder and commit; the placeholders will then display in this README.
